...
echo $SG_FOR_WORKERS
echo "First instance IP - "
echo $PUBLIC_IP_1
echo "Second instance ID - "
echo $PUBLIC_IP_2


echo "waiting 200 seconds for all the dependencies to install, user data scripts takes time."
sleep 200
...
ssh -i $KEY_PEM -o "StrictHostKeyChecking=no" -o "ConnectionAttempts=10" ubuntu@$PUBLIC_IP_2 'sudo service redis restart'
